...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_LEAF1_Ethernet1 | *trunk | *- | *- | *['MLAG'] | 1 |
| Ethernet2 | SPINE1_Ethernet3 | *trunk | *10 | *- | *- | 2 |
| Ethernet3 | SPINE2_Ethernet3 | *trunk | *10 | *- | *- | 2 |
| Ethernet4 | HOSTA_eth2 | *access | *10 | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_LEAF1_Ethernet6 | *trunk | *- | *- | *['MLAG'] | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_LEAF1_Po1 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
